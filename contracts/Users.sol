...
contract Users {
    ...
    function addUser(Types.UserDetails memory user, address myAccount)
        internal
    {
        require(myAccount != address(0), "Your address is Empty");
        require(user.id_ != address(0), "User's address is Empty");
        ...
        returns (Types.UserDetails memory)
    {
        ...
        require(users[account].id_ != address(0), "User does not exist");
